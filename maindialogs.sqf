...
_moneh  = 'moneh' call INV_GetItemAmount;_zusatzString = "";
...
if (_art == "spielerliste") then
{
	...
	lbAdd [1, format ["Money: $%2", localize "STRS_statdialog_health", (('moneh' call INV_GetItemAmount) call ISSE_str_IntToStr)]];
	lbAdd [1, format ["Savings: $%2", localize "STRS_statdialog_health", (bankaccount call ISSE_str_IntToStr)]];
//	lbAdd [1, format ["%1: %2",    localize "STRS_statdialog_hunger", round(INV_hunger)]];
	...
	//lbAdd [1, format["boar meat: %1", _stock]];
	...
	//lbAdd [1, format["dolphin: %1", _stock]];
	...
	lbAdd [1, _trennlinie];
	lbAdd [1, localize "STRS_statdialog_playerlist"]; 	//HotFix by HarryWorner 03.April.2012
