...
_this addWeaponCargo ["BAF_AS50_scoped", _amountWeapon]; _this addMagazineCargo ["5Rnd_127x99_as50", _amountAmmo];
...
_this addWeaponCargo ["BAF_LRR_scoped", _amountWeapon]; _this addMagazineCargo ["5Rnd_86x70_L115A1", _amountAmmo];
...
_this addWeaponCargo ["BAF_NLAW_Launcher", _amountWeapon]; _this addMagazineCargo ["NLAW", _amountAmmo];
...
_this addMagazineCargo ["BAF_ied_v1", _amountAmmo];
_this addMagazineCargo ["BAF_ied_v2", _amountAmmo];
_this addMagazineCargo ["BAF_ied_v3", _amountAmmo];
_this addMagazineCargo ["BAF_ied_v4", _amountAmmo];
...
_this addWeaponCargo ["FN_FAL_ANPVS4", _amountWeapon];_this addMagazineCargo ["20Rnd_762x51_FNFAL", _amountAmmo];
