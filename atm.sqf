...
CtrlSetText [101, format [localize "STRS_bank_dialog_inventarmoneh", (_moneh call ISSE_str_IntToStr)]];
CtrlSetText [102, format [localize "STRS_bank_dialoge_accountmoneh",  (bankaccount call ISSE_str_IntToStr)]];
