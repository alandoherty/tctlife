...
INV_action_facworkers = player addaction [format["Hire factory worker ($%1)", facworkercost], "facqueue.sqf", _i];
INV_action_facworkers2 = player addaction [format["Hire 10 factory workers ($30000)", facworkercost], "facqueue2.sqf", _i];
