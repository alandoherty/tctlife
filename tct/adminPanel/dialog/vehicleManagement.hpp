...
class VehicleManagement {
	...
	onLoad = "[4] execVM 'adminPanel\populateVehicles.sqf'";

	class controlsBackground {
		
		class MainBackground: AdminMenu_Picture
		{
			idc = -1;
	...
	class controls {
		...
		class vehicleListBox: w_RscListBox
		{
			...
			onLBSelChanged="[1,_this select 1] execVM ""adminPanel\importvalues.sqf"";";
		...
		class civButton: RscButton
		{
			idc = vehicleManagementCivButton;
			onButtonClick = "[0] execVM 'adminPanel\populateVehicles.sqf'";
			text = "Cars/Trucks";
		...
		class heliButton: RscButton
		{
			idc = vehicleManagementHeliButton;
			onButtonClick = "[1] execVM 'adminPanel\populateVehicles.sqf'";
			text = "Helicopters";
		...
		class planeButton: RscButton
		{
			idc = vehicleManagementPlaneButton;
			onButtonClick = "[2] execVM 'adminPanel\populateVehicles.sqf'";
			text = "Planes";
			x = 0.305 * safezoneW + safezoneX;
		...
		class tankButton: RscButton
		{
			...
			onButtonClick = "[3] execVM 'adminPanel\populateVehicles.sqf'";
			text = "Tanks";
			x = 0.38 * safezoneW + safezoneX;
			y = 0.730 * safezoneH + safezoneY;
			w = 0.065 * safezoneW;
		...
		class hackedVehiclesButton: RscButton
		{
			idc = -1;
			onButtonClick = "[4] execVM 'adminPanel\populateVehicles.sqf'";
		...
		{
			idc = -1;
			onButtonClick = "execVM 'adminPanel\deleteVehicle.sqf'";
			text = "Delete Vehicle";
		...
		class deleteAllButton: RscButton
		{
			idc = -1;
			onButtonClick = "execVM 'adminPanel\deleteAllHackedVehicles.sqf'";
			text = "Delete All";
