...
if(_moneh < MGcost)exitwith{player groupchat "not enough money"};

['moneh', -MGcost] call INV_addinventoryitem;
...
if(_moneh < PKcost)exitwith{player groupchat "not enough money"};

['moneh', -PKcost] call INV_addinventoryitem;
