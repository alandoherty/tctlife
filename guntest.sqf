...
if(_score >= 55)then
	...
	licenseflag2 sidechat format["congratulations %1 you passed the test and have received your pistol license!", name player];
...

{
	...
	{
		if (_moneh >= 40000) then
		{
			INV_LizenzOwner = INV_LizenzOwner + ["riflelicense"];
			["moneh", -(40000)] call INV_addinventoryitem;
			licenseflag2 sidechat format["You recieved a rifle license!", name player]
		}
		else
		{
