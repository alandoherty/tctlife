_art         = _this select 0;
_stunbullets = [ "B_12Gauge_74Slug", "B_12Gauge_74Slug", "F_40mm_White", 1, "B_9x19_SD", "15Rnd_9x19_M9SD"];
...
if(player distance copbase1 < 130 and iscop and vehicle player == player) exitwith
...
if(player distance getmarkerpos "respawn_civilian" < 100) exitwith
