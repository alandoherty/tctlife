...
if(_moneh < gangcreatecost)exitwith{player groupchat "not enough money"};

['moneh', -gangcreatecost] call INV_addinventoryitem;
...
for "_c" from 0 to (count gangsarray - 1) do 
	...
	if(_name in _members and (side player != civilian))then
